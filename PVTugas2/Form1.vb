Public Class Form1
    ...
    Private Sub btnDoUntillLoop_Click(sender As Object, e As EventArgs) Handles btnDoUntillLoop.Click
        'Declare variables
    ...
    Private Sub btnForNextLoopStep_Click(sender As Object, e As EventArgs) Handles btnForNextLoopStep.Click
        'Declare variable
        Dim intCount As Integer
        'Clear the list
        ClearList()
        'Perform a loop
        For intCount = 4 To 62 Step 7
            'Add the item to the list
            lstData.Items.Add(intCount.ToString)
        Next
    End Sub

    Private Sub btnForBackwardLoop_Click(sender As Object, e As EventArgs) Handles btnForBackwardLoop.Click
        'Declare variable
        Dim intCount As Integer
        'Clear the list
        ClearList()
    ...
    Private Sub btnEachLoop_Click(sender As Object, e As EventArgs) Handles btnEachLoop.Click
        'Clear the list
        ClearList()
    ...
    Private Sub btnNestedLoop_Click(sender As Object, e As EventArgs) Handles btnNestedLoop.Click
        ClearList()
